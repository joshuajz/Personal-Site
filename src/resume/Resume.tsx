...
const Resume = () => {
	return (<>
			...
			<h1 className='text-8xl font-bold mb-8'>Experience</h1>
				<Timeline active={0} bulletSize={24} lineWidth={2} className='ml-20'>
					<Timeline.Item bullet={<Bank />} title="Royal Bank of Canada">
					...
					<Timeline.Item bullet={<Bank />} title="Royal Bank of Canada">
						<Text c="dimmed" size="sm">Software Developer Intern</Text>
						<Text size="xs" mt={2}>May 2023 - August 2023</Text>
					</Timeline.Item>

					<Timeline.Item bullet={<Bank />} title="Royal Bank of Canada">
						<Text c="dimmed" size="sm">Software Developer Intern</Text>
						<Text size="xs" mt={2}>May 2022 - August 2022</Text>
					</Timeline.Item>
				</Timeline>
			</div>
		</>
